...
sudo /opt/WinCC_OA/3.15/bin/WCCOActrl -proj 3.15 -n -log +stderr /opt/winccoa/Infrastructure-as-Code-AWS/winccoa/createWinccOaProj.ctl  ${winccoaSysNum} ${winccoaSysName} ${winccoaSub1Ip}
