...
#switch progs
sudo cp /opt/winccoa/Infrastructure-as-Code-AWS/modules/winccoaSystem/winccoa/progs_master /opt/winccoa/proj/config/progs
#copy webserver script
sudo cp /opt/winccoa/Infrastructure-as-Code-AWS/modules/winccoaSystem/winccoa/webserver.ctl /opt/winccoa/proj/scripts/webserver.ctl
